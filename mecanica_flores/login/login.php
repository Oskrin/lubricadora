<?php  
	...
	if(isset($_POST['consultar_login_user'])) {
		...
		$resultado = $class->consulta("SELECT *, (SELECT data FROM privilegios P WHERE  U.id_cargo = P.id_cargo) AS data_privilegio FROM usuarios U WHERE U.usuario = '".$_POST['txt_nombre']."' and clave = md5('".$_POST['txt_clave']."')");
