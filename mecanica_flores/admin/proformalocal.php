<?php
  ...
  function correo($fecha, $valor, $pdf, $nombre, $correo, $dataPDF,$tipoEnvio ) {  
    ...
    $mail->IsHTML(true);                                 
    $mail->Subject = "Proforma"; $mail->Body = '
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                            <tr>
                                                <td align="left" class="mobile-padding" style="padding:20px; text-align:justify">
                                                    ...
                                                    <br>
                                                    <br> Su Proforma con fecha al '.$fecha.',  cuyo valor es de $ '.$valor.' usd, ha sido generado con éxito.
                                                    <br>
                                                </td>
