<?php 
	...
	if (isset($_POST['Guardar']) == "Guardar") {
		...
		// auditoria insert
		$class->consulta("INSERT INTO auditoria VALUES ('".$_SESSION['user']['id']."','".gethostname()."','Clientes','INSERT','".$_POST['razon_social']."','','','$id_cliente','$fecha')");	
	...
	if (isset($_POST['Modificar']) == "Modificar") {
		...
		// auditoria update
		$class->consulta("INSERT INTO auditoria VALUES ('".$_SESSION['user']['id']."','".gethostname()."','Clientes','UPDATE','".$_POST['razon_social']."','','','".$_POST['id_cliente']."','$fecha')");
