app.controller('cuentas_cobrarController', function ($scope, $interval) {
	...
	jQuery(function($) {
		...
		$scope.methodoview = function(id) { 
			$('#myModal').modal('show');
			jQuery("#table2").jqGrid('setGridParam',{url:"data/cuentas_cobrar/xml_pagos.php?id_cuenta="+id,page:1}).trigger("reloadGrid");
		}
		// fin
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        datatype: "xml",
		    url: 'data/cuentas_cobrar/xml_cuentas.php',
	        colNames: ['ID','RUC/CI','CLIENTE','FACTURA','FECHA CREDITO','TIEMPO','PLAZO','MONTO','SALDO','CUENTA','ACCION'],
	        colModel:[ 
	            ...
	            {name: 'cliente', index: 'cliente', editable: false, search: false, hidden: false, editrules: {edithidden: false}, align: 'center', frozen: true, width: 300},
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector2).jqGrid({
	        ...
	        colModel:[ 
	            ...
	            {name:'descipcion',index:'descipcion',frozen : true, hidden: false, align:'left', search:true,width: '240'},
