<?php 
	...
	if (isset($_POST['Guardar']) == "Guardar") {
		...
		// auditoria insert
		$class->consulta("INSERT INTO auditoria VALUES ('".$_SESSION['user']['id']."','".gethostname()."','Proveedores','INSERT','".$_POST['razon_social']."','','','$id_proveedor','$fecha')");
	...
	if (isset($_POST['Modificar']) == "Modificar") {
		...
		// auditoria update
		$class->consulta("INSERT INTO auditoria VALUES ('".$_SESSION['user']['id']."','".gethostname()."','Proveedores','UPDATE','".$_POST['razon_social']."','','','".$_POST['id_proveedor']."','$fecha')");
