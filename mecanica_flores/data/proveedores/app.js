app.controller('proveedoresController', function ($scope, $route) {
	...
	jQuery(function($) {
		...
		$('#form_proveedores').validate({
			...
			messages: {
				...
				identificacion: {
					...
					//unique: "El Proveedor ya se encuentra Registrado"
				},
				razon_social: { 	
		...
		$('#btn_descargar').click(function() {
			var archivo = "data/proveedores/plantilla/proveedores.xlsx";
			window.open(archivo);
		});
		// fin
		...
		jQuery(function($) {
		    ...
		    jQuery(grid_selector).jqGrid({	        
		        ...
		        ondblClickRow: function(rowid) {     	            	            
	            	...
	            	$("#logo").attr("src", "data/proveedores/fotos/"+ ret.foto);
		        ...
		        editurl: "data/proveedores/app.php",
