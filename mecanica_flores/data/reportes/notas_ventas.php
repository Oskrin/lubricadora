<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {                         
            ...
            $this->Cell(150, 5, "NOTA VENTA", 0,1, 'R', 0);      
            ...
            $this->Cell(190, 5, utf8_decode("RESUMEN DE NOTAS VENTAS"),0,1, 'C',0);                                                                                                                            
            $this->SetFont('Amble-Regular','',10);        
            $this->Ln(3);
    ...
    $pdf->Cell(30, 6, utf8_decode('Nº Nota'),1,0, 'C',0);                                     
    ...
    $resultado = $class->consulta("SELECT F.id, F.fecha_emision, F.secuencial, F.subtotal, F.tarifa, F.tarifa0, F.iva, F.total_descuento, F.total_nota FROM nota_venta F, clientes C WHERE F.id_cliente = C.id AND F.fecha_emision BETWEEN '$_GET[inicio]' AND '$_GET[fin]' ORDER BY F.id ASC");                        
