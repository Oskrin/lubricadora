...
class PDF extends PDF_Rotate {
    ...
    $resultado = $class->consulta("SELECT N.id, C.identificacion, C.razon_social, C.direccion, C.telefono2, C.ciudad, N.fecha_emision, N.subtotal, N.tarifa0, N.tarifa, N.iva, N.total_descuento, N.total_nota FROM nota_venta N, clientes C WHERE N.id_cliente = C.id AND N.id = '$_GET[id]'");    
    ...
    while ($row = $class->fetch_array($resultado)) {
        ...
        $pdf->SetY($posiciony);
        $pdf->SetX(163);
        $pdf->multiCell(75, 6, utf8_decode($total_venta),0);
