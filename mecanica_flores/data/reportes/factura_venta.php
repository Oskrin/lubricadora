...
class PDF extends PDF_Rotate {
    ...
    $resultado = $class->consulta("SELECT C.razon_social, C.identificacion, C.direccion, C.telefono2, C.ciudad, F.fecha_emision, P.nombre_forma, F.tarifa, F.tarifa0, F.iva, F.total_descuento, F.total_venta, F.efectivo, F.cambio, F.estado FROM factura_venta F, clientes C, formas_pago P WHERE F.id_cliente = C.id AND F.id = '$_GET[id]'");    
