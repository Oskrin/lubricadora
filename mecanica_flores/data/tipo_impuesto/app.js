app.controller('tipo_impuestoController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
			...
			colNames:['ID','CÓDIGO','TIPO IMPUESTO','PRINCIPAL','OBSERVACIONES','ACTIVAR','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_tipo_impuesto',index:'nombre_tipo_impuesto', width:250, editable:true, editoptions:{size:"20", maxlength:""}, editrules: {required: true}, editrules: {required: true}, editoptions:{dataInit: function(elem){$(elem).bind("keyup", function(e) {this.value = this.value.toUpperCase(e)})}}},
